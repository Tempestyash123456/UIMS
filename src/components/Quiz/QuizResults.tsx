...
import { QuizCategory, QuizQuestion as QuizQuestionType, QuizState } from '../../types';
...
export default function QuizResults({
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-3xl w-full bg-white rounded-2xl shadow-lg p-8 my-8">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-8">
            Great job completing the {category.name} assessment! Here are your results.
          </p>
